...
import { Phone, Clock, Globe, AlertTriangle, Heart, Users, MessageCircle } from "lucide-react";
...
const urgentHelplines = [
  {
    ...
    description: "Free emotional support for anyone in distress, struggling to cope, or at risk of suicide.",
...
const specialistHelplines = [
  ...
  },
  {
    ...
    description: "Support for young people under 35 experiencing suicidal thoughts.",
  ...
  },
  {
    ...
    description: "Support for under 25s via phone, email, peer support and counselling.",
...
const onlineSupport = [
  ...
  {
    name: "Kooth",
    description: "Free online counselling and emotional well-being platform for young people.",
...
const copingStrategies = [
  ...
  },
  {
    ...
    description: "Use the 5-4-3-2-1 technique: 5 things you see, 4 you can touch, 3 you hear, 2 you smell, 1 you taste.",
    icon: <Users className="w-5 h-5" />
  },
  {
    title: "Reach Out",
    description: "Contact a trusted friend, family member, or one of the helplines above.",
...
export default function CrisisPage() {
  return (
    <div className="min-h-screen bg-[#F6EDE1]">
      ...
      {/* Hero Section */}
      <section className="bg-[#FF3939] text-white py-16">
        <div className="container mx-auto px-8">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
              If you're in immediate danger, call <strong>999</strong> now. 
            ...
            <div className="bg-white/10 p-6 rounded-lg max-w-2xl mx-auto">
              <p className="text-lg font-semibold">
                🚨 If you are in immediate danger or having thoughts of suicide, please call 999 or go to your nearest A&E department.
              </p>
            </div>
          </div>
        </div>
            ...
            {urgentHelplines.map((helpline, index) => (
              <div 
                ...
                className={`p-6 rounded-lg shadow-md transition-all duration-200 hover:shadow-lg ${
                  helpline.urgent ? 'bg-red-50 border-2 border-red-200' : 'bg-[#F8EFE2] border-2 border-[#F8EFE2]'
                }`}
              >
                <div className="flex items-start gap-4">
                  <div className={`p-3 rounded-full ${helpline.urgent ? 'bg-red-100 text-red-600' : 'bg-[#045741] text-white'}`}>
                    {helpline.icon}
                  </div>
                  <div className="flex-1">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-700">{helpline.availability}</span>
                      </div>
                    </div>
                    ...
                    {helpline.textSupport && (
                      <div className="mt-3 p-3 bg-blue-50 rounded-md">
                        <p className="text-sm text-blue-800">
                          📱 <strong>Text Support:</strong> {helpline.textSupport}
                        </p>
                      </div>
                    )}
                    {helpline.website && (
      ...
      <section className="py-16 bg-[#F8EFE2]">
        <div className="container mx-auto px-8">
          <h2 className="text-3xl font-bold text-center mb-12 text-[#0b6344]">
            Immediate Coping Strategies
          </h2>
            ...
            {copingStrategies.map((strategy, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 bg-[#045741] text-white rounded-full">
                    {strategy.icon}
                  </div>
                  <h3 className="font-semibold text-[#0b6344]">{strategy.title}</h3>
                </div>
        ...
        <div className="container mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {specialistHelplines.map((helpline, index) => (
              <div key={index} className="bg-[#F8EFE2] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Clock className="w-4 h-4 text-gray-600" />
                    <span className="text-sm text-gray-700">{helpline.availability}</span>
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <h3 className="font-semibold text-[#0b6344] mb-2">It's Okay to Ask for Help</h3>
                <p className="text-gray-700 text-sm">
                  Seeking help is a sign of strength, not weakness. Professional support can make a real difference.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <Users className="w-12 h-12 text-[#3A3FC1] mx-auto mb-4" />
                <h3 className="font-semibold text-[#0b6344] mb-2">You Matter</h3>
                <p className="text-gray-700 text-sm">
                  Your life has value and meaning. There are people who care about you and want to help.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <Clock className="w-12 h-12 text-[#045741] mx-auto mb-4" />
                <h3 className="font-semibold text-[#0b6344] mb-2">This Feeling is Temporary</h3>
                <p className="text-gray-700 text-sm">
                  However you're feeling right now, it won't last forever. Help is available and recovery is possible.
                </p>
              </div>
            </div>
