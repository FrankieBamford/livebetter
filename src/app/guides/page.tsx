...
const guides = [
  {
    ...
    description: "Learn about anxiety triggers, symptoms, and effective coping strategies.",
    category: "Mental Health",
    readTime: "10 min read",
  },
  {
    title: "Mindfulness Meditation",
    description: "A beginner's guide to mindfulness meditation and its benefits.",
    category: "Wellness",
    readTime: "8 min read",
  },
  {
    title: "Stress Management",
    description: "Practical techniques for managing daily stress and maintaining balance.",
    category: "Self-Care",
    readTime: "12 min read",
  },
  {
    title: "Building Healthy Habits",
    description: "Step-by-step guide to developing and maintaining positive habits.",
    category: "Lifestyle",
    ...
    <div className="min-h-screen bg-[#F7EFE2]">
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">Wellness Guides</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore our collection of expert-curated guides to help you on your journey to better mental health and wellness.
          </p>
        </div>
            ...
            <Card key={index} className="hover:shadow-lg transition-shadow duration-200">
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    <span className="text-sm font-medium text-orange-500">{guide.category}</span>
